		...
		_createClass(Routine, [{
			...
			value: function handleError(routine, error) {
				...
				if (routine.handlers.error) {
					...
					try {
						for (var _iterator5 = routine.handlers.error[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
